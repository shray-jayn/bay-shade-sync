...
export const products: Product[] = [
  {
    ...
    description:
      "Our most popular interior solution combines clean aesthetics with whisper-quiet motorization. Perfect for modern homes that demand both style and smart functionality.",
    features: [
  ...
  },
  {
    ...
    description:
      "Alternating sheer and opaque fabric bands offer infinite light control. Shift between privacy and view with a single motor adjustment.",
    features: [
  ...
  },
  {
    ...
    description:
      "Fabric vanes suspended between sheer layers create a floating, luxurious look. Roman shades offer classic tailored folds with modern automation.",
    features: [
  ...
  },
  {
    ...
    description:
      "Cellular construction traps air for superior insulation. Reduce heating and cooling costs while enjoying whisper-quiet motorized operation.",
    features: [
  ...
  },
  {
    ...
    description:
      "Transform your patio into a year-round retreat. Our zip-track system handles wind, rain, and sun while maintaining clear sightlines and motorized convenience.",
    features: [
    ...
    useCases: ["Covered patios and decks", "Outdoor dining areas", "Pool cabanas", "Balconies and terraces"],
  ...
  },
  {
    ...
    description:
      "Retractable awnings extend your living space outdoors. Motorized operation with sun and wind sensors provides automatic climate adaptation.",
    features: [
    ...
    useCases: ["Patios and decks", "Outdoor kitchens", "Restaurant seating areas", "West or south-facing exposures"],
    finishes: ["Sunbrella Acrylic (100+ colors)", "Solution-Dyed Acrylics", "Custom Stripes"],
  },
];

// Convenience export if you need just the names elsewhere
